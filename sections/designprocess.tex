...
%TODO: Add an introduction to the Design Process
    ...
    \subsection{Mechanical Design} 
        ...
        \subsubsection{Kinematics and Analysis}
            ...
            With any robot there is math and analysis that needs to be done to make sure that the robot will properly do what you want it to. The majority of the kinematics that was done was applying everything we knew about forward and inverse kinematics for a 3 degree of freedom leg and applying it to a 4 degree of freedom leg. With a redundant 4 dof system like ours the leg has additional limb inline with several others causing infinite solutions if you are just trying to solve the kinematics for an X,Y,Z point in space. As a result an additional term is added in to define the angle of the fourth link giving the system at most two solutions for a given X,Y,Z and theta value.
