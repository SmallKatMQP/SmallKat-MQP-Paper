    ...
    \subsection{Mechanical Design} 
        ...
        \subsubsection{Kinematics and Analysis}
            ...
            \begin{figure}[H]
             ...
             \paragraph{Force Propagation} Once the D-H parameters, forward and inverse kinematics of the system are established you can start getting into more complicated math to analyze the system. One such analysis is called force propagation. Essentially this allows us to apply a simulated force on the end-effector of our robot and calculate what each of the torques on the links are by propagation that force through each limb of the leg. This is extremly useful as it allows us to get a rough estimation of what the torques on each of the 
